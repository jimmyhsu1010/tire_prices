...
class PrinterPricePipeline(object):
    def open_spider(self, spider):
        ...
        self.writer = csv.writer(self.file)
        self.writer.writerow(
            ['日期', '品牌', '型號', '價格', '類型', '列印類型', '技術', '每月列印量', '最大尺寸', '自動雙面列印', '最大解析度',
    ...
    def process_item(self, item, spider):
        ...
        self.writer.writerow((item['date'], item['brand'], item['model'], item['price'], item['type'],
                              ...
                              item['first_print'], item['scanner_type'], item['scanner_size'], item['scanner_resolution'],
                              ...
                              item['first_copier_time'], item['tray_capacity'], item['manual_tray_capacity'], item['toner_life'],
                              item['interface'], item['wifi_print'], item['direct_print'], item['web_interface'], item['support_os'],
